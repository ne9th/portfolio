...
export const HomeAbout = () => {
    ...
    return(
        ...
        className='d-flex flex-column home-about align-items-center justify-content-center'>
            <div ref = {ref} className="text-center f-prompt brief-about d-flex align-items-center justify-content-center">
